# -*- coding: utf-8 -*-
"""Proyek_Akhir_Movie_Recommendation_System_Fachry .ipynb

Automatically generated by Colab.

Original file is located at
    https://colab.research.google.com/drive/1SY7IUfYYfyK2mMy_Ov29ddMuZ6cR2_rY

# Proyek Akhir: Movie Recommendation System
...
Dataset yang digunakan berupakan **Movie Recommendation Data** yang diperoleh dari [kaggle](https://www.kaggle.com/datasets/rohan4050/movie-recommendation-data/data).
...
Memuat dataset `movies.csv` dan `ratings.csv` yang diperoleh dari kaggle untuk memahami struktur data.
"""
...
!unzip movie-recommendation-data.zip -d dataset/

# Memuat dataset
movies = pd.read_csv('/content/dataset/ml-latest-small/movies.csv')
ratings = pd.read_csv('/content/dataset/ml-latest-small/ratings.csv')
...
"""## Model and Result (Content-based Filtering)
...
"""## Model and Result (Collaborative Filtering)
